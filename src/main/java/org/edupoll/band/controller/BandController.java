...
public class BandController {
	...
	public String createAlbum(@PathVariable String bandRoomId, @RequestParam String albumname,
	...
	public String showAlbumDetail(@PathVariable int albumId, @PathVariable String bandRoomId, Model model) {
