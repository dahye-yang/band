		...
		<div style="width: 750px; margin: auto">
			...
			<input type="hidden" value="" name="coverImageUrl" id="coverImageUrl">
				...
				<div class="d-flex justify-content-center gap-4">
					<div>
						<button onclick="location.href='${pageContext.servletContext.contextPath }/band/${bandRoom.bandRoomId}'" type="button" style="width: 150px; height: 42px; border: 1px solid #E2E2E2" class="rounded-1">
							취소
						</button>
					</div>
					<div>
